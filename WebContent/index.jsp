...
<div class="gallery">
    <div class="container">
            ...
            <c:forEach items="${hotList}" var="g">
                <div class="col-md-4 gallery-grid glry-two">
                    <a href="<%=request.getContextPath()%>/goods_detail?id=${g.id}">
                        <img src="<%=request.getContextPath()%>/${g.cover}" class="img-responsive" alt="${g.name}" width="350" height="350"/>
                    </a>
        ...
        <div class="clearfix"></div>
        <div class="alert alert-info">新图书推荐</div>
        <div class="gallery-grids">
            <c:forEach items="${newList}" var="g">
                <div class="col-md-3 gallery-grid ">
                    <a href="<%=request.getContextPath()%>/goods_detail?id=${g.id}">
                        <img src="<%=request.getContextPath()%>/${g.cover}" class="img-responsive" alt="${g.name}"/>
                    </a>
