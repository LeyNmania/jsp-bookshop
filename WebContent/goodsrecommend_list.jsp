...
<div class="products">
    <div class="container">
        <h2><c:choose><c:when test="${t==2}">热销图书</c:when><c:otherwise>新图书图书</c:otherwise></c:choose></h2>
                ...
                <div class="product-grid">
                    <a href="<%=request.getContextPath()%>/goods_detail?id=${g.id}">
                        ...
                        <div class="product-img b-link-stripe b-animate-go  thickbox">
                            <img src="<%=request.getContextPath()%>/${g.cover}" class="img-responsive" alt="${g.name}" width="240" height="240">
                            <div class="b-wrapper">
                                <h4 class="b-animate b-from-left  b-delay03">
                                    <button href="<%=request.getContextPath()%>/goods_detail?id=${g.id}">查看详情</button>
                                </h4>
                            </div>
                        </div>
                    </a>
